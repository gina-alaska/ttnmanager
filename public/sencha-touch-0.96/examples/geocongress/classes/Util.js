...
//            baseCls: 'x-button',
            handler: Ext.createDelegate(this.btnCallback, this, [btn]),
            scope: this,
    ...
    reconfigure: function(type, cfg) {
        ...
        this.userCallback = Ext.createDelegate(cfg.callback || Ext.emptyFn, cfg.scope || window);

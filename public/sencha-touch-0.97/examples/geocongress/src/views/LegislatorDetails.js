Geo.views.LegislatorDetails = Ext.extend(Ext.Panel, {
    ...
    initComponent: function() {
        ...
        this.bills = new Ext.List({
            ...
            tpl: Ext.XTemplate.from('bills'),
            itemSelector: '.legislator-bills'
        });
        ...
        this.votes = new Ext.List({
            ...
            tpl: Ext.XTemplate.from('votes'),
            emptyText: "No Recent Votes",
            itemSelector: '.legislator-votes'
        });
    ...
    onBillTap: function(dv, index, item, e) {
        ...
        this.setCard(this.billSummary, Geo.defaultAnim);
    },

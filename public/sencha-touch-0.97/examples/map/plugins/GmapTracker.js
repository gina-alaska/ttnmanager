...
Ext.plugin.GMap.Tracker = Ext.extend(Ext.util.Observable, {
    ...
    constructor : function(config) {
        ...
        this.hasGeoLocation = !!this.provider && 'getCurrentPosition' in this.provider;
    ...
    startUpdates : function() {
        if (this.hasGeoLocation && 'watchPosition' in this.provider) {
    ...
    getLocation : function(callback, scope) {
        ...
        if (me.hasGeoLocation && !me.coords) {
            ...
            setTimeout(function() {
                callback.call(scope || me, me.hasGeoLocation ? me.coords : null, me);
            }, 0);
        }
    },
    ...
    updateLocation : function(callback, scope) {
        ...
        if (me.hasGeoLocation) {
            ...
            me.provider.getCurrentPosition(
                ...
                me.onError,
                {
                    enableHighAccuracy: !!me.highAccuracy,
    ...
    destroy : function() {
       ...
       if (this.hasGeoLocation && this.watchId) {
            this.provider.clearWatch(this.watchId);
       }
       if (this.pollId) {

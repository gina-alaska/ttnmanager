...
class AlertsControllerTest < ActionController::TestCase
  ...
  test "should create alert" do
    assert_difference('Alert.count') do
      post :create, alert: { active: @alert.active, area_id: @alert.area_id, system: @alert.system, text: @alert.text }
    end
  ...
  test "should update alert" do
    patch :update, id: @alert, alert: { active: @alert.active, area_id: @alert.area_id, system: @alert.system, text: @alert.text }
    assert_redirected_to alert_path(assigns(:alert))
  end
